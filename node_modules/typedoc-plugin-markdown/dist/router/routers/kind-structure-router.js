...
export class KindStructureRouter extends MarkdownRouter {
    buildChildPages(reflection, outPages) {
        ...
        if (kind) {
            ...
            if (this.isPackages) {
                ...
                const replaceFilename = (originalPath, newFileName) => {
                ...
                if (meta &&
                    ...
                    const packageEntryFileName = meta.options.isSet('entryFileName')
                        ...
                        : this.entryFileName;
                    this.fullUrls.set(reflection, replaceFilename(actualName, packageEntryFileName));
                    outPages.push({
                        kind: PageKind.Index,
                        model: reflection,
    ...
    getIdealBaseNameVerbose(reflection) {
        let dir = null;
        let fileName = '';
